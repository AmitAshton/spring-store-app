...
/**
 * this class includes all the logic for the transaction services,
 * like handling a buying and selling transactions...
 */
...
public class TransactionService {
    ...
    public TransactionResult buy(TransactionDetails request) throws ItemNotExistsInShop, ItemNotEnoughQuantity {
        ...
        List<Long> itemIds = request.getItems().stream().map(ItemTransactionRequest::getItemId).collect(Collectors.toList());
