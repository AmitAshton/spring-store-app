...
/**
 * this class includes all the logic for the item services,
 * like creating a new item, updating one, getting one and all, getting the price and more...
 */
@Service
...
public class ItemService {
    ...
    public List<ItemQuantity> fetchShopItems(Long shopId, List<Long> itemIds, boolean mustExists) throws ItemNotExistsInShop {
        List<ItemQuantityKey> itemQuantityKeys = itemIds.stream().map(x -> new ItemQuantityKey(x, shopId)).collect(Collectors.toList());
